...
def create_andalucia_trip(user)
  andalucia = Trip.create!(
    name: "Trip to Andalucía (#{user_label(user)})",
    description: "A nice autumn getaway to the south of Spain",
    destination: "Andalucía",
    group_size: 4,
    vibe: "relaxed",
    image_url: "https://loremflickr.com/800/450/andalucia,seville?lock=1",
    user: user
  )
...
def create_japan_trip(user)
  japan = Trip.create!(
    name: "Trip to Japan (#{user_label(user)})",
...
def create_peru_trip(user)
  peru = Trip.create!(
    name: "Trip to Peru (#{user_label(user)})",
    description: "An adventurous trip through Lima, the Sacred Valley, and Machu Picchu",
    destination: "Peru",
    group_size: 3,
    vibe: "adventurous",
    image_url: "https://loremflickr.com/800/450/peru,machupicchu?lock=3",
    user: user
  )
...
def create_hawaii_trip(user)
  hawaii = Trip.create!(
    name: "Trip to Hawaii (#{user_label(user)})",
    description: "A relaxed week on Oahu, mixing beaches with a bit of hiking and history",
    destination: "Hawaii",
    group_size: 2,
    vibe: "relaxed",
    image_url: "https://loremflickr.com/800/450/hawaii,beach?lock=4",
    user: user
  )
...
def create_catalunya_trip(user)
  catalunya = Trip.create!(
    name: "Trip to Catalunya (#{user_label(user)})",
    description: "A cultural family trip through Barcelona and day trips around Catalunya",
    destination: "Catalunya",
    group_size: 4,
    vibe: "cultural",
    image_url: "https://loremflickr.com/800/450/barcelona,catalunya?lock=5",
    user: user
  )
  ...
  Activity.create!(
    ...
    start_date: DateTime.new(2025, 9, 10, 15, 0, 0),
    end_date: DateTime.new(2025, 9, 10, 15, 30, 0),
    notes: "Reservation under Camila. We should have 2 rooms.",
    category: "accommodation",
    image_url: "https://loremflickr.com/640/480/hotel,barcelona,accommodation",
    latitude: 41.383900,
    longitude: 2.176500,
  ...
  Activity.create!(
    ...
    start_date: DateTime.new(2025, 9, 10, 17, 0, 0),
    end_date: DateTime.new(2025, 9, 10, 19, 0, 0),
    notes: nil,
    category: "sightseeing",
    image_url: "https://loremflickr.com/640/480/walk,barri,gotic,sightseeing",
    latitude: 41.383300,
    longitude: 2.176100,
  ...
  Activity.create!(
    ...
    start_date: DateTime.new(2025, 9, 10, 21, 0, 0),
    end_date: DateTime.new(2025, 9, 10, 22, 30, 0),
    notes: "Reservation for 4 under Camila.",
    category: "food",
    image_url: "https://loremflickr.com/640/480/tapas,dinner,rambla,food",
    latitude: 41.380900,
    longitude: 2.173100,
  ...
  Activity.create!(
    ...
    start_date: DateTime.new(2025, 9, 11, 9, 30, 0),
    end_date: DateTime.new(2025, 9, 11, 11, 0, 0),
    notes: "Rooftop access has separate opening hours.",
    category: "sightseeing",
    image_url: "https://loremflickr.com/640/480/visit,barcelona,cathedral,sightseeing",
    latitude: 41.383900,
    longitude: 2.176500,
  ...
  Activity.create!(
    ...
    start_date: DateTime.new(2025, 9, 11, 12, 0, 0),
    end_date: DateTime.new(2025, 9, 11, 14, 0, 0),
    notes: "Book timed tickets online well in advance.",
    category: "sightseeing",
    image_url: "https://loremflickr.com/640/480/visit,sagrada,familia,sightseeing",
    latitude: 41.403600,
    longitude: 2.174400,
  ...
  Activity.create!(
    ...
    start_date: DateTime.new(2025, 9, 11, 14, 0, 0),
    end_date: DateTime.new(2025, 9, 11, 15, 0, 0),
    notes: nil,
    category: "food",
    image_url: "https://loremflickr.com/640/480/lunch,sagrada,familia,food",
    latitude: 41.403200,
    longitude: 2.173900,
  ...
  Activity.create!(
    ...
    start_date: DateTime.new(2025, 9, 11, 17, 0, 0),
    end_date: DateTime.new(2025, 9, 11, 19, 0, 0),
    notes: nil,
    category: "sightseeing",
    image_url: "https://loremflickr.com/640/480/explore,born,sightseeing",
    latitude: 41.385000,
    longitude: 2.182700,
  ...
  Activity.create!(
    ...
    start_date: DateTime.new(2025, 9, 12, 9, 0, 0),
    end_date: DateTime.new(2025, 9, 12, 11, 0, 0),
    notes: "Timed entry tickets required for the monumental zone.",
    category: "sightseeing",
    image_url: "https://loremflickr.com/640/480/visit,park,guell,sightseeing",
    latitude: 41.414500,
    longitude: 2.152700,
  ...
  Activity.create!(
    ...
    start_date: DateTime.new(2025, 9, 12, 12, 0, 0),
    end_date: DateTime.new(2025, 9, 12, 13, 30, 0),
    notes: nil,
    category: "sightseeing",
    image_url: "https://loremflickr.com/640/480/visit,casa,batllo,sightseeing",
    latitude: 41.391600,
    longitude: 2.164900,
  ...
  Activity.create!(
    ...
    start_date: DateTime.new(2025, 9, 12, 13, 30, 0),
    end_date: DateTime.new(2025, 9, 12, 14, 30, 0),
    notes: nil,
    category: "food",
    image_url: "https://loremflickr.com/640/480/lunch,passeig,gracia,food",
    latitude: 41.393000,
    longitude: 2.164700,
  ...
  Activity.create!(
    ...
    start_date: DateTime.new(2025, 9, 12, 15, 30, 0),
    end_date: DateTime.new(2025, 9, 12, 17, 0, 0),
    notes: nil,
    category: "sightseeing",
    image_url: "https://loremflickr.com/640/480/visit,casa,mila,pedrera",
    latitude: 41.395300,
    longitude: 2.161900,
  ...
  Activity.create!(
    ...
    start_date: DateTime.new(2025, 9, 13, 10, 0, 0),
    end_date: DateTime.new(2025, 9, 13, 13, 0, 0),
    notes: nil,
    category: "beach",
    image_url: "https://loremflickr.com/640/480/relax,barceloneta,beach",
    latitude: 41.378400,
    longitude: 2.192500,
  ...
  Activity.create!(
    ...
    start_date: DateTime.new(2025, 9, 13, 13, 30, 0),
    end_date: DateTime.new(2025, 9, 13, 15, 0, 0),
    notes: "Reservation for 4 under Camila.",
    category: "food",
    image_url: "https://loremflickr.com/640/480/seafood,lunch,barceloneta,food",
    latitude: 41.376800,
    longitude: 2.189700,
  ...
  Activity.create!(
    ...
    start_date: DateTime.new(2025, 9, 13, 16, 0, 0),
    end_date: DateTime.new(2025, 9, 13, 17, 30, 0),
    notes: nil,
    category: "sightseeing",
    image_url: "https://loremflickr.com/640/480/visit,port,vell,maremagnum",
    latitude: 41.376800,
    longitude: 2.183700,
  ...
  Activity.create!(
    ...
    start_date: DateTime.new(2025, 9, 13, 19, 0, 0),
    end_date: DateTime.new(2025, 9, 13, 20, 30, 0),
    notes: nil,
    category: "leisure",
    image_url: "https://loremflickr.com/640/480/sunset,drinks,beach,bar",
    latitude: 41.379000,
    longitude: 2.191500,
    address: "Platja de la Barceloneta, 08003 Barcelona",
    trip_day: catalunya_day_four
  ...
  Activity.create!(
    ...
    start_date: DateTime.new(2025, 9, 14, 8, 30, 0),
    end_date: DateTime.new(2025, 9, 14, 9, 30, 0),
    notes: "Journey takes under 40 minutes on the fastest trains.",
    category: "transportation",
    image_url: "https://loremflickr.com/640/480/train,girona,transportation",
    latitude: 41.379200,
    longitude: 2.140400,
  ...
  Activity.create!(
    ...
    start_date: DateTime.new(2025, 9, 14, 10, 0, 0),
    end_date: DateTime.new(2025, 9, 14, 12, 30, 0),
    notes: "Fans of Game of Thrones will recognize the cathedral steps.",
    category: "sightseeing",
    image_url: "https://loremflickr.com/640/480/explore,gironas,old,town",
    latitude: 41.986500,
    longitude: 2.824700,
  ...
  Activity.create!(
    ...
    start_date: DateTime.new(2025, 9, 14, 12, 30, 0),
    end_date: DateTime.new(2025, 9, 14, 13, 30, 0),
    notes: nil,
    category: "food",
    image_url: "https://loremflickr.com/640/480/lunch,girona,food",
    latitude: 41.983100,
    longitude: 2.824900,
  ...
  Activity.create!(
    ...
    start_date: DateTime.new(2025, 9, 14, 17, 0, 0),
    end_date: DateTime.new(2025, 9, 14, 18, 0, 0),
    notes: nil,
    category: "transportation",
    image_url: "https://loremflickr.com/640/480/train,back,barcelona,transportation",
    latitude: 41.986500,
    longitude: 2.824700,
  ...
  Activity.create!(
    ...
    start_date: DateTime.new(2025, 9, 15, 8, 30, 0),
    end_date: DateTime.new(2025, 9, 15, 10, 0, 0),
    notes: "Combined rail + cable car tickets can be bought at Barcelona Espanya station.",
    category: "transportation",
    image_url: "https://loremflickr.com/640/480/cable,car,montserrat,transportation",
    latitude: 41.593800,
    longitude: 1.838300,
  ...
  Activity.create!(
    ...
    start_date: DateTime.new(2025, 9, 15, 10, 0, 0),
    end_date: DateTime.new(2025, 9, 15, 12, 0, 0),
    notes: nil,
    category: "sightseeing",
    image_url: "https://loremflickr.com/640/480/visit,montserrat,monastery,basilica",
    latitude: 41.593800,
    longitude: 1.838300,
    address: "Montserrat, 08199 Barcelona",
    trip_day: catalunya_day_six
  ...
  Activity.create!(
    ...
    start_date: DateTime.new(2025, 9, 15, 12, 30, 0),
    end_date: DateTime.new(2025, 9, 15, 15, 0, 0),
    notes: "A funicular covers part of the ascent if legs are tired.",
    category: "hiking",
    image_url: "https://loremflickr.com/640/480/hike,sant,jeroni,viewpoint",
    latitude: 41.601900,
    longitude: 1.812900,
  ...
  Activity.create!(
    ...
    start_date: DateTime.new(2025, 9, 15, 20, 0, 0),
    end_date: DateTime.new(2025, 9, 15, 21, 30, 0),
    notes: "Reservation for 4 under Camila.",
    category: "food",
    image_url: "https://loremflickr.com/640/480/farewell,dinner,barcelona,food",
    latitude: 41.386000,
    longitude: 2.170000,
  ...
  Activity.create!(
    ...
    start_date: DateTime.new(2025, 9, 16, 10, 0, 0),
    end_date: DateTime.new(2025, 9, 16, 10, 30, 0),
    notes: "Reservation under Camila.",
    category: "accommodation",
    image_url: "https://loremflickr.com/640/480/barcelona,hotel,accommodation",
    latitude: 41.383900,
    longitude: 2.176500,
    address: "Av. de la Catedral, 7, Ciutat Vella, 08002 Barcelona",
  ...
  Activity.create!(
    ...
    start_date: DateTime.new(2025, 9, 16, 11, 0, 0),
    end_date: DateTime.new(2025, 9, 16, 11, 45, 0),
    notes: nil,
    category: "transportation",
    image_url: "https://loremflickr.com/640/480/transfer,barcelona,airport,transportation",
    latitude: 41.297100,
    longitude: 2.078500,
...
[angelo, marvin, tugdual, ben, camila].each do |user|
  create_andalucia_trip(user)
  create_japan_trip(user)
  create_peru_trip(user)
  create_hawaii_trip(user)
  create_catalunya_trip(user)
end
